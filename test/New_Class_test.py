...
class Game_real_score_Test(TestCase):
    ...
    def test_common_win(self):
        self.assertEqual(New_Class.Game.real_score(21, 11), 1)  # common win

    def test_common_win1(self):
        self.assertEqual(New_Class.Game.real_score(21, 19), 1)  # common win

    def test_common_lose(self):
        self.assertEqual(New_Class.Game.real_score(11, 21), 0)  # common lose

    def test_common_lose1(self):
        self.assertEqual(New_Class.Game.real_score(19, 21), 0)  # common lose

    def test_balance_win(self):
        self.assertEqual(New_Class.Game.real_score(22, 20), 0.8)  # balance win

    def test_balance_win1(self):
        self.assertEqual(New_Class.Game.real_score(28, 26), 0.8)  # balance win

    def test_balance_lose(self):
        self.assertEqual(New_Class.Game.real_score(20, 22), 0.2)  # balance lose

    def test_balance_lose1(self):
        self.assertEqual(New_Class.Game.real_score(21, 23), 0.2)  # balance lose

    def test_more10_win(self):
        self.assertEqual(New_Class.Game.real_score(21, 10), 1.2)  # more 10 win

    def test_more10_win1(self):
        self.assertEqual(New_Class.Game.real_score(21, 3), 1.2)  # more 10 win

    def test_more10_lose(self):
        self.assertEqual(New_Class.Game.real_score(10, 21), -0.2)  # more 10 lose

    def test_more10_lose1(self):
        self.assertEqual(New_Class.Game.real_score(2, 21), -0.2)  # more 10 lose

    def test_error1(self):
        self.assertEqual(New_Class.Game.real_score(10, 8), None)  # more 10 lose
...
class Game_wait_score_1_Test(TestCase):
    ...
    def test_wait_score_1_newUsers(self):
        ...
        self.assertEqual(self.temp.wait_score_1(), 0.5)
    ...
    def test_wait_score_1_NotNewUsers(self):
        ...
        self.assertEqual(self.temp.wait_score_1(), 0.7597469266479578)
...
class Game_wait_score_2_Test(TestCase):
    ...
    def test_wait_score_2_newUsers(self):
        ...
        self.assertEqual(self.temp.wait_score_2(), 0.5)

    def test_wait_score_2_NotNewUsers(self):
        self.temp = New_Class.Game(New_Class.Player('Win'), New_Class.Player('Lose'), New_Class.Player('Won', 450), New_Class.Player('Lase', 450), 21, 12)
        self.assertEqual(self.temp.wait_score_2(), 0.2402530733520421)
...
class Game_real_score_1_Test(TestCase):
    ...
    def test_real_score_1_newUsers(self):
        self.temp = New_Class.Game(New_Class.Player('Win', 300), New_Class.Player('Lose', 300), New_Class.Player('Won', 300), New_Class.Player('Lase', 300), 21, 12)
        self.assertEqual(self.temp.real_score_1(), 10)
    ...
    def test_real_score_1_NotNewUsers(self):
        ...
        self.assertEqual(self.temp.real_score_1(), 0.1980198019801982)

class Game_real_score_2_Test(TestCase):

    def test_real_score_2_newUsers(self):
        self.temp = New_Class.Game(New_Class.Player('Win'), New_Class.Player('Lose'), New_Class.Player('Won'), New_Class.Player('Lase'), 21, 12)
        self.assertEqual(self.temp.real_score_2(), -10)
    ...
    def test_real_score_2_NotNewUsers(self):
        ...
        self.assertEqual(self.temp.real_score_2(), -1.8181818181818183)
