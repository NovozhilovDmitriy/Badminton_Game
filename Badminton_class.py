...
class Game(Pair):
    ...
    def wait_score_1(self):
        ...
        return 1 / (2 + 10 ** (self.pair1.get_pair_avr_score(self.player1, self.player2) - self.pair2.get_pair_avr_score(self.player1,self.player2) / 400))

    def wait_score_2(self):
        #  Found waiting score of the Pair2 in game by Elo formula.
        return 1 / (2 + 10 ** (self.pair2.get_pair_avr_score(self.player1, self.player2) - self.pair2.get_pair_avr_score(self.player1,self.player2) / 400))
